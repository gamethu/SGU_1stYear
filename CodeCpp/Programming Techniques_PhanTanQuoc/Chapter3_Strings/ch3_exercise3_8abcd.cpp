...
void findStudent(HOSO *hs,int num){
...
void countStudent(HOSO *hs,int num){
...
void findMaxStudent(HOSO *hs,int num){
...
void LinearSearchStudent(HOSO *hs,int num){
    char s[20];
...
int main(){
    ...
    findStudent(hs,num);
    countStudent(hs,num);
    findMaxStudent(hs,num);
    LinearSearchStudent(hs,num);
